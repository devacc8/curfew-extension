...
Optional mode for the hard days. When enabled, every permissive change —
staying on a closed site, disabling a budget, removing a site, importing —
asks you to **solve a challenge** first:
